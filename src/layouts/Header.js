          ...
          <div className="d-flex">
            <div className="dropdown d-inline-block">
              ...
              <div className={profile ? "dropdown-menu dropdown-menu-end show drop-showing" : "dropdown-menu dropdown-menu-end"}>
                <label className="dropdown-item cursor-pointer" ><i className="bx bxs-user font-size-16 align-middle me-1"></i> <span key="t-profile"><Link to="/profile" onClick={() => setprofile(false)}>Profile</Link></span></label>
